/* Exercicio 3.1 - Se a função f devolver um valor float64 não finito
 * o arquivo SVG conterá elementos <polygon> inválidos [..]. Modifique o programa para ignorar
 * os poligonos inválidos que forem gerados. */
package main
